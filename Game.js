class Game{
    ...
    start(){
        textSize(20);
        fill ("white");
        text("Max is a boy who is running away from the Coronavirus which is chasing him.",width/2-300,height/4);
        ...
        text("and other safety precautions to help him reach home safely.",width/2-225,height/4+150);
        textSize(50);
        fill ("white");
        textStyle(BOLD);
